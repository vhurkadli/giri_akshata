...
import Im1 from './pics/im3.jpg';
import { FaMapMarkerAlt } from "react-icons/fa";
import B21 from "./pics/b21.png";
import B33 from "./pics/b33.png";
...
function App() {
  ...
  const textColorClass1 = colorChange ? "text-violet-400" : "text-pink-500";
  ...
  return (
    <div style={{ height: "auto", overflow: "hidden" }}>
      ...
      >
        ...
        <div className="pt-10">
          <div
            className={`text-gray-500 text-4xl mt-4 text-center
             ${textColorClass1} ${
              language === "kannada"
                ? "tracking-wide text-6xl"
                : "tracking-widest2 text-4xl font-bold"
            } font-poppin`}>
            <p
              style={{
                marginLeft: 25,
          ...
          <div
            className={`${
              language === "kannada"
                ...
                : " px-2 py-1 rounded-lg  mx-auto"
            } text-xl mt-1 text-center font-dancing tracking-wide opacity-60 `}>
            <p
              style={{
                textShadow: "2px 2px 4px rgba(0, 0, 0, 0.3)",
                animation: "glitter 0.7s infinite alternate",
                // color: "gray",
              }}>
              {/* Are Getting Married */}
          ...
          <div style={{ opacity: 0.8 }} className="mt-5 text-center">
            <img
              src={B21}
      ...
      <div
        ...
        style={{
          ...
          backgroundSize: " auto 100%", // Adjust this value to control the zoom level
        ...
        <a
          ...
          className="fixed bottom-8 right-8 bg-pink-500 text-white px-1 py-1 rounded-md text-3xl shadow-2xl opacity-60"
          style={{
